...
Future<String> requestAnswerAPI(
    BuildContext context, String content, int idQuestion) async {
  ...
  final response = await httpClient.post(
      url + "/answers/" + userId.toString() + "/" + idQuestion.toString(),
      body: jsonQuestion,
      headers: headers);
  ...
  if (response.statusCode == 200) {
    ...
    showDialogSingleButton(
        context, "Error on share answer", "Contact the support", "OK");
    return null;
  }
}
